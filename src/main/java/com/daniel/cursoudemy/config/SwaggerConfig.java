...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.daniel.cursoudemy.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "Esta API criada junto ao curso da Udemy",
                "Versão 1.0",
                "https://www.udemy.com/terms",
                new Contact("Daniel Paulino", "https://danielpaulinomesquita.github.io/", "darcouver@gmail.com"),
                "Permitido para aprendizado em programação",
                "https://github.com/danielPaulinoMesquita/CursoUdemySpring",
